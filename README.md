...
**Created**: 2026-08-23  
**Status**: KB **v2.2** (2026-08-26) — consolidación quest-engine + gaps map + hardening   
...
> Nota: el commit `63c9b40` usó "KB v0.9" como nomenclatura de trabajo; la versión canónica interna es v2.2.
